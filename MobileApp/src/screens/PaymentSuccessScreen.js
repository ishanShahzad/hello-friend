    ...
    <GlassBackground>
      <View style={styles.content}>
        ...
        <Animated.View style={{ opacity: fadeAnim, alignItems: 'center' }}>
          ...
          {orderId && <GlassPanel variant="inner" style={styles.orderBadge}><Ionicons name="receipt-outline" size={14} color={palette.colors.primary} /><Text style={styles.orderIdText}>Order: {orderId}</Text></GlassPanel>}
          <View style={styles.infoRow}><Ionicons name="time-outline" size={16} color={palette.colors.textSecondary} /><Text style={styles.infoText}>Processing your order now</Text></View>
          <View style={styles.infoRow}><Ionicons name="mail-outline" size={16} color={palette.colors.textSecondary} /><Text style={styles.infoText}>Confirmation email sent</Text></View>
        </Animated.View>
      </View>
...
const buildStyles = (p) => StyleSheet.create({
  ...
  iconInner: { width: 96, height: 96, borderRadius: 48, backgroundColor: p.colors.success, justifyContent: 'center', alignItems: 'center' },
  ...
  orderIdText: { fontSize: fontSize.sm, fontWeight: fontWeight.semibold, color: p.colors.primary },
  infoRow: { flexDirection: 'row', alignItems: 'center', gap: spacing.sm, marginBottom: spacing.sm },
  infoText: { fontSize: fontSize.sm, color: p.colors.textSecondary },
